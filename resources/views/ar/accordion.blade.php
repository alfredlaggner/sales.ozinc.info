                    ...
                    <div class="card-header" id="headingOne{{$i}}">
                        ...
                        <table class="table table-bordered table-sm table-responsive-lg">
                            ...
                            @php
                                ...
                                100%";}
                                elseif ($ars_total->is_felon == 2) {$felony_state = "worse"; $felon_color="color: #2b2828;
                                font-size: 100%";}
                            ...
                            <tr>
                                ...
                                <td id="is_felon_toggle1{{$loopCounter}}"  style= "{{$felon_color}}" class="text-xl-left"><b>{{substr($ars_total->customer,0,20)}}</b></td>
                                ...
                                @foreach ($ols as $sl)
                                    ...
                                    <tr>
                                        <td data-bs-toggle="tooltip"
                                            ...
                                            title="Click here to see the invoice"
                                            style="cursor: pointer; "
                                            id="get_invoice{{$sl->salesorder_id}}">
                                            {{$sales_order}}
                                        </td>
                                    ...
                                    <script>
                                        ...
                                        $(document).on('click', '#get_invoice{{$sl->salesorder_id}}', function (event) {
                                            event.preventDefault();
                                            //     let href = $(this).attr('data-attr');
                                            //   alert("this works too {{$sl->salesorder_id}}");
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (result) {
                                                    $('#mediumModal{{$sl->salesorder_id}}').modal("show");
                                                    $('#mediumBody{{$sl->salesorder_id}}').html(result).show();
                                                },
                                                complete: function () {
                                                    $('#loader').hide();
                                                },
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="mediumModal{{$sl->salesorder_id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div id="mediumBody{{$sl->salesorder_id}}" class="modal-body">
                        ...
                        $("#btn-submit{{$loopCounter}}").click(function (e) {
                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    ...
                                    $('#felon_color{{$loopCounter}}').text(result.felony_state);
                                    $('#is_felon_toggle1{{$loopCounter}}').css("color", result.color);
