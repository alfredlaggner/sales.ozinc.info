                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <table id="brands0" class="table table-bordered table-hover table-sm table-responsive-lg">
                                <thead>
                                <tr>
                                    <th>Brand</th>
                                    <th class="text-xl-right">Sales $</th>
                        ...
                        <div class="col-xl-6">
                            ...
                            <table id="brands1" class="table table-bordered table-hover table-sm table-responsive-lg">
                                <thead>
                                <tr>
                                    <th>Brand</th>
                                    <th class="text-xl-right">Sales $</th>
