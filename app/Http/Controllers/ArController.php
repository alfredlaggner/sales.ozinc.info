...
class ArController extends Controller
{
    ...
    public function new_aged_receivables(Request $request, $rep_id = 71)
    {
...
//dd($rep_id);
    ...
    function ajaxRequestPost(Request $request)
    {
        ...
        if ($is_felon == 0) {
            ...
            $color = "FF8000";
            $felony_state = "bad";
            $felony_color = "color: #FF8000; font-size: 100%";
            ...
            $color = "2b2828";
            $felony_state = "worse";
            $felony_color = "color: #ffc107; font-size: 100%";
            ...
            $color = "FF0040";
            $felony_state = "worst";
            $felony_color = "color:#FF0040; font-size: 100%";
